...
C--- SECURE TEST TO KNOW IF DIS EVENT WAS WELL GENERATED.
        IF(FRCGEN.NE.0) THEN
          IF(LST(21).NE.0.OR.K(1,1).EQ.21) THEN
            GOTO 3995
          ENDIF
        ENDIF
...
C
     ...
     &     ' MINIMUM ALLOWED W, X, Y'
        WRITE(LUNOUT,*) 'NEW Q2MIN : ', Q2MIN
        WRITE(LUNOUT,*) 'NEW Q2MAX : ', Q2MAX
...
C-------------------------
     ...
     +                HSXE31(100),HSXE32(100),HSXE33(100)
      ...
      DOUBLE PRECISION          PHEPSV, VHKKSV
      INTEGER         IDHSV
      SAVE /HEPSAV/
C-------------------------
      CHARACTER*45 CHNAME
...
C      COMMON /HSPARM/ POLARI,HPOLAR,LEPTID,LLEPT,LQUA
