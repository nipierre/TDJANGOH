...
C---INTEGRATION
        ...
        HSXCC2(1)%SIG2C=SIG2C
        HSXCC2(1)%SIG2EC=SIG2EC
        WRITE(LUNOUT,'(//A/5X,A/5X,1PE12.4,A,1PE12.4,A)')
     *       ' CROSS SECTION (WITH ERROR ESTIMATE) FOR THE CHANNEL:',
     *       CHNAME(2), HSXCC2(1)%SIG2C, ' +/- ', HSXCC2(1)%SIG2EC,
     *       '  NB'
        WRITE(LUNTES,'(5X,A,1PD10.1)') ' RELATIVE ACCURACY REQUIRED:',
     &      EPSO
C---LOCAL/GLOBAL MAXIMA FOR THE MODIFIED SAMPLING FUNCTION
...
C---INTEGRATION
        ...
        HSXEL2(1)%SIG2L=SIG2L
        HSXEL2(1)%SIG2EE=SIG2EE
        WRITE(LUNOUT,'(//A/5X,A/5X,1PE12.4,A,1PE12.4,A)')
     *       ' CROSS SECTION (WITH ERROR ESTIMATE) FOR THE CHANNEL:',
     *       CHNAME(3), HSXEL2(1)%SIG2L, ' +/- ', HSXEL2(1)%SIG2EE,
     *       '  NB'
        WRITE(LUNTES,'(5X,A,1PD10.1)') ' RELATIVE ACCURACY REQUIRED:',
     &      EPSO
C---LOCAL/GLOBAL MAXIMA FOR THE MODIFIED SAMPLING FUNCTION
