...
C---LOCAL/GLOBAL MAXIMA FOR THE MODIFIED SAMPLING FUNCTION
     ...
     *              HSXNC2(1)%T2GGMA,HSXNC2(1)%T2GMAX,
     *              HSXNC2(1)%XX2,HSXNC2(1)%IBIM2,NREG2N)
...
C--------------------------------------------------------------------
     ...
     *     ' COMPTON CONTRIBUTION                 ',
     *       SIG33L, ' +/- ', SG33EE, '  NB'
        SIGTW=HSXNC2(1)%SIG2+SIG31+SIG32+SIG33+SIG34
     *       +SIG2C+SIG31C+SIG32C+SIG33C
     *       +SIG2L+SIG31L+SIG32L+SIG33L
        SIGEW=DSQRT(HSXNC2(1)%SIG2E**2+SIG31E**2+SIG32E**2+SIG33E**2+SIG34E**2
