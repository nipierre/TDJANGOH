...
double fZrange[5] = {.2,.3,.4,.6,.8};
double fpTrange[31] = {.02,.04,.06,.08,.1,.12,.14,.17,.196,
                       .23,.27,.30,.35,.40,.46,.52,.6,.68,
                       .76,.87,1.,1.12,1.24,1.38,1.52,1.68,1.85,
                       2.05,2.35,2.65,3.};
double fZ_bin_width[4] = {.1,.1,.2,.2};
double fpT_bin_width[30] = {.02,.02,.02,.02,.02,.02,.03,.026,.034,
                            .04,.03,.05,.05,.06,.06,.08,.08,.08,
                            .11,.13,.12,.12,.14,.14,.14,.17,.2,
                            .3,.3,.35};
